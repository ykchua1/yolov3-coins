...
preprocessing = [FindEdges()]
dataset = ImageAnnotationDataset("./data/scattered_coins/train/", transform=transforms.Compose([CV2toPIL(), *preprocessing, RandRotate(20), PILtoCV2(), PrepImage()]))
dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=0)
val_dataset = ImageAnnotationDataset("./data/scattered_coins/val/", transform=transforms.Compose([CV2toPIL(), *preprocessing, PILtoCV2(), PrepImage()]), rng=3)
